...
class SaleOrder(models.Model):
    ...
    shipstation_account_id = fields.Many2one("shipstation.accounts", "Shipstation Account", ondelete='restrict', copy=False,
    ...
    shipstation_order_key = fields.Char(string='Shipstation OrderKey', copy=False)
